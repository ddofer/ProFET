...
SEED = 5  # always use a seed for randomized procedures
...
from scipy.stats import randint as sp_randint
Tree_param_dist = {"n_estimators" : sp_randint(50, 600),
                   "max_depth" : sp_randint(2, 9), "max_features" : sp_randint(6, 70),
                   "min_samples_split" : sp_randint(1, 10), "min_samples_leaf" : sp_randint(1, 8),
                   "criterion" : ["gini"], "bootstrap" : [True]}
# "criterion": ["gini", "entropy"]}

SVM_param_grid = [{'C' : [1, 10, 100, 1000], 'kernel' : ['linear', 'rbf'], 'gamma' : [0.001, 0.0001]}]
