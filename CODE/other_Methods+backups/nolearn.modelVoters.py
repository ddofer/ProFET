'Source: https://pythonhosted.org/nolearn/_modules/nolearn/model.html#AveragingEstimator'
'Change average to MODE!'
import numpy as np
...
class AveragingEstimator(BaseEstimator):
    ...
    :meth:`predict_proba`.
    """
    def __init__(self, estimators, verbose=0, n_jobs=-2):
        """
