...
def FilterFastaSeqGroups (Dir,fName,minGroupCount = 30,minLength= 29,FilterGroups=True):
    ...
    def FiltSequences (handle,minLength=31):
        '''
...
if __name__=="__main__":
    ...
    for f in FastaFiles:
        FilterFastaSeqGroups (Dir,f,minGroupCount = minCounts,minLength= 24,FilterGroups=True)