...
# In[ ]:
    ...
    rf = RandomForestClassifierWithCoef(max_depth= 8, min_samples_split= 3, min_samples_leaf= 3, n_estimators= 150,  n_jobs= -1, max_features= "auto")
...
#    print("X RF f1: %0.3f (+- %0.2f)" % (scores_f1.mean(), scores_f1.std() * 2))
    ...
    rfeSelect = RFE(estimator=rf,n_features_to_select=7, step=0.15)
